...
jobs = [{
    ...
    'tasks': [{
        ...
        'source_file': get_dir('autosave_ClusterNNTry00_V130/XXX'),
    }, {
        'name': '001_ex_timit',
        'source_file': get_dir('autosave_ClusterNNTry00_V122/XXX'),
    }, {
        'name': '002_ex_coil_100',
        'source_file': get_dir('autosave_ClusterNNTry00_V136/XXX'),
    }, {
        'name': '003_ex_facescrub',
        'source_file': get_dir('autosave_ClusterNNTry00_V126/XXX'),
    }, {
        'name': '004_ex_tiny_imagenet',
        'source_file': get_dir('autosave_ClusterNNTry00_V1290/XXX'),
    },
    ]
}]
        ...
        metric_plots = [
            {
                ...
                'title': 'Accuracy',
                'data': [
                    ('Cluster Count: Training', 'cluster_count_output_categorical_accuracy'),
                    ('Cluster Count: Validation', 'val_cluster_count_output_categorical_accuracy'),
