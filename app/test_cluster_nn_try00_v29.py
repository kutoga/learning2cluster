...
from impl.nn.try00.cluster_nn_try00_v29 import ClusterNNTry00_V29
...
if __name__ == '__main__':
    ...
    en = CnnEmbedding(
        output_size=420, cnn_layers_per_block=1, block_feature_counts=[32, 64],
    ...
    c_nn = ClusterNNTry00_V29(dp, 20, en, lstm_layers=7, lstm_units=64, cluster_count_dense_layers=1, cluster_count_dense_units=256,
                              output_dense_layers=1, output_dense_units=256, cluster_count_lstm_layers=2, cluster_count_lstm_units=96,

                              # kl_embedding_size = train speaker count
                              kl_embedding_size=420)
    ...
    autosave_dir = top_dir + 'test/autosave_ClusterNNTry00_V29'
    c_nn.register_autosave(autosave_dir, example_count=15, nth_iteration=250)
