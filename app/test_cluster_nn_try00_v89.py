...
if __name__ == '__main__':
    ...
    en = CnnBDLSTMEmbedding(
        bdlstm_layers_units=[128, 128],
        output_size=256, cnn_layers_per_block=1, block_feature_counts=[32, 64, 128],
        fc_layers_units=[256], hidden_activation=LeakyReLU(), final_activation=LeakyReLU(),
    ...
    autosave_dir = top_dir + 'test/autosave_ClusterNNTry00_V89'
