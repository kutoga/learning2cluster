...
if __name__ == '__main__':
    ...
    c_nn = ClusterNNTry00_V02(dp, 50, en, lstm_layers=15, lstm_units=128, cluster_count_dense_layers=1, cluster_count_dense_units=128,
    ...
    autosave_dir = top_dir + 'test/autosave_ClusterNNTry00_V03'
