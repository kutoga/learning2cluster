...
if __name__ == '__main__':
    ...
    c_nn = ClusterNNTry00_V51(dp, required_input_count, en, lstm_layers=7, internal_embedding_size=96, cluster_count_dense_layers=1, cluster_count_dense_units=256,
    ...
    c_nn.test_network(count=5, output_directory=autosave_dir_target + '/evaluation', data_type='test', create_date_dir=False)
