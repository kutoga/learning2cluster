...
if __name__ == '__main__':
    ...
    c_nn = ClusterNNTry00_V12(dp, 102, en, lstm_layers=7, lstm_units=96, cluster_count_dense_layers=1, cluster_count_dense_units=128,
                          output_dense_layers=1, output_dense_units=192)
    ...
    autosave_dir = top_dir + 'test/autosave_ClusterNNTry00_V12'
