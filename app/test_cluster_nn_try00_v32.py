...
if __name__ == '__main__':
    ...
    en = CnnEmbedding(
        output_size=36,
        cnn_layers_per_block=2, block_feature_counts=[64, 128],
        fc_layer_feature_counts=[512, 512], hidden_activation=LeakyReLU(), final_activation=LeakyReLU(),
        batch_norm_for_init_layer=False, batch_norm_after_activation=True, batch_norm_for_final_layer=True,
        dropout_init=.5, dropout_after_max_pooling=[.5, .5]
    )

    c_nn = ClusterNNTry00_V30(dp, 20, en, lstm_layers=7, internal_embedding_size=32, cluster_count_dense_layers=1, cluster_count_dense_units=256,
                              output_dense_layers=1, output_dense_units=256, cluster_count_lstm_layers=2, cluster_count_lstm_units=96,
                              kl_embedding_size=36)
    ...
    autosave_dir = top_dir + 'test/autosave_ClusterNNTry00_V32'
