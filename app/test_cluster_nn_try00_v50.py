...
from impl.nn.try00.cluster_nn_try00_v50 import ClusterNNTry00_V50
...
if __name__ == '__main__':
    ...
    en = CnnEmbedding(
        output_size=256, cnn_layers_per_block=1, block_feature_counts=[64, 128, 256],
        ...
        dropout_after_fc=[0.5], dropout_after_max_pooling=[0.5, 0.5, 0.5], dropout_init=0.5
    )

    c_nn = ClusterNNTry00_V50(dp, 20, en, lstm_layers=7, internal_embedding_size=96, cluster_count_dense_layers=1, cluster_count_dense_units=256,
    ...
    autosave_dir = top_dir + 'test/autosave_ClusterNNTry00_V50'
