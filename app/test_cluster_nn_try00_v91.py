...
if __name__ == '__main__':
    ...
    c_nn = ClusterNNTry00_V51(dp, 20, en, lstm_layers=14, internal_embedding_size=288, cluster_count_dense_layers=1, cluster_count_dense_units=256,
    ...
    autosave_dir = top_dir + 'test/autosave_ClusterNNTry00_V91'
