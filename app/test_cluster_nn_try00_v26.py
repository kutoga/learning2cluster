...
from impl.nn.try00.cluster_nn_try00_v26 import ClusterNNTry00_V26
...
if __name__ == '__main__':
    ...
    en = CnnEmbedding(
        output_size=512, cnn_layers_per_block=1, block_feature_counts=[32, 64],
    ...
    c_nn = ClusterNNTry00_V26(dp, 20, en, lstm_layers=15, internal_embedding_size=128, cluster_count_dense_layers=1, cluster_count_dense_units=256,
    ...
    autosave_dir = top_dir + 'test/autosave_ClusterNNTry00_V26'
