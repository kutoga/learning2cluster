...
if __name__ == '__main__':
    ...
    if testing:
        ...
        c_nn = ClusterNNTry03KMeansV04(
            dp, 3, en, lstm_layers=2, lstm_units=8, kmeans_itrs=2,
        ...
        autosave_dir = top_dir + 'test/autosave_ClusterNNTry03KMeansV04'
        ...
        c_nn = ClusterNNTry03KMeansV04(
            dp, 50, en, lstm_layers=5, lstm_units=32, kmeans_itrs=5,
            cluster_count_dense_layers=0, cluster_count_dense_units=1,
            kmeans_input_dimension=2
        )
        c_nn.weighted_classes = True
