...
from impl.nn.try00.cluster_nn_try00_v20 import ClusterNNTry00_V20
...
if __name__ == '__main__':
    ...
    c_nn = ClusterNNTry00_V20(dp, 20, en, lstm_layers=7, internal_embedding_size=96, cluster_count_dense_layers=1, cluster_count_dense_units=256,
    ...
    autosave_dir = top_dir + 'test/autosave_ClusterNNTry00_V20'
