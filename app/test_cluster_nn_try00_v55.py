...
from impl.nn.try00.cluster_nn_try00_v52 import ClusterNNTry00_V52
...
if __name__ == '__main__':
    ...
    c_nn = ClusterNNTry00_V52(dp, 20, en, lstm_layers=7, internal_embedding_size=96, cluster_count_dense_layers=1, cluster_count_dense_units=256,
                              output_dense_layers=1, output_dense_units=256, cluster_count_lstm_layers=1, cluster_count_lstm_units=128,
                              kl_embedding_size=128, kl_divergence_factor=0.1, cluster_count_bdlstm_layer_source_index=7)
    ...
    autosave_dir = top_dir + 'test/autosave_ClusterNNTry00_V55'
