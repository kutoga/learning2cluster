...
from impl.nn.try00.cluster_nn_try00_v07 import ClusterNNTry00_V07
...
if __name__ == '__main__':
    ...
    c_nn = ClusterNNTry00_V07(dp, 50, en, lstm_layers=5, lstm_units=64, cluster_count_dense_layers=1, cluster_count_dense_units=128,
    ...
    autosave_dir = top_dir + 'test/autosave_ClusterNNTry00_V07'
