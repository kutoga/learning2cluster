...
if __name__ == '__main__':
    ...
    c_nn = ClusterNNTry00_V23(dp, 20, en, lstm_layers=3, internal_embedding_size=128, cluster_count_dense_layers=1, cluster_count_dense_units=256,
    ...
    autosave_dir = top_dir + 'test/autosave_ClusterNNTry00_V36'
