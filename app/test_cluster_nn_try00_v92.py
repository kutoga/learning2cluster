...
from impl.nn.try00.cluster_nn_try00_v92 import ClusterNNTry00_V92
...
if __name__ == '__main__':
    ...
    c_nn = ClusterNNTry00_V92(dp, 20, en, internal_embedding_size=288, cluster_count_dense_layers=1, cluster_count_dense_units=256,
                              output_dense_layers=1, output_dense_units=256, cluster_count_lstm_layers=1, cluster_count_lstm_units=384,
                              kl_embedding_size=128, kl_divergence_factor=0.1,
                              bdlstm_layers_pre_blocks=1, bdlstm_layers_post_blocks=1, bdlstm_block_size=4, bdlstm_blocks=3
                              )
    ...
    autosave_dir = top_dir + 'test/autosave_ClusterNNTry00_V92'
