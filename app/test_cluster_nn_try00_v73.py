...
if __name__ == '__main__':
    ...
    c_nn = ClusterNNTry00_V51(dp, 40, en, lstm_layers=32, internal_embedding_size=512, cluster_count_dense_layers=1, cluster_count_dense_units=512,
                              output_dense_layers=1, output_dense_units=512, cluster_count_lstm_layers=1, cluster_count_lstm_units=512,
    ...
    autosave_dir = top_dir + 'test/autosave_ClusterNNTry00_V73'
