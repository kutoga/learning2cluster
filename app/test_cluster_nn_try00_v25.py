...
from impl.nn.try00.cluster_nn_try00_v25 import ClusterNNTry00_V25
...
if __name__ == '__main__':
    ...
    en = CnnEmbedding(
        ...
        max_pooling_size=4, max_pooling_stride=2
    )

    c_nn = ClusterNNTry00_V25(dp, 20, en, lstm_layers=7, internal_embedding_size=96, cluster_count_dense_layers=1, cluster_count_dense_units=256,
    ...
    autosave_dir = top_dir + 'test/autosave_ClusterNNTry00_V25'
