...
from impl.nn.try00.cluster_nn_try00_v11 import ClusterNNTry00_V11
...
if __name__ == '__main__':
    ...
    en = SimpleFCEmbedding(output_size=8, hidden_layers=[16, 32, 64, 64], hidden_activation=LeakyReLU(), final_activation='tanh')
    # en = None

    c_nn = ClusterNNTry00_V11(dp, 102, en, lstm_layers=5, lstm_units=96, cluster_count_dense_layers=1, cluster_count_dense_units=128,
    ...
    autosave_dir = top_dir + 'test/autosave_ClusterNNTry00_V11'
