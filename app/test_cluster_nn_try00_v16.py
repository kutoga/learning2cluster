...
if __name__ == '__main__':
    ...
    en = CnnEmbedding(
        output_size=32, cnn_layers_per_block=1, block_feature_counts=[32, 64],
        fc_layer_feature_counts=[], hidden_activation=LeakyReLU(), final_activation='tanh',
        batch_norm_for_init_layer=True
    )

    c_nn = ClusterNNTry00_V16(dp, 20, en, lstm_layers=4, lstm_units=64, cluster_count_dense_layers=1, cluster_count_dense_units=256,
                              output_dense_layers=1, output_dense_units=256, cluster_count_lstm_layers=1, cluster_count_lstm_units=64)
    ...
    autosave_dir = top_dir + 'test/autosave_ClusterNNTry00_V16'
    c_nn.register_autosave(autosave_dir, example_count=10, nth_iteration=500, print_loss_plot_every_nth_itr=50)
