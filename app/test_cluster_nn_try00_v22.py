...
from impl.nn.try00.cluster_nn_try00_v22 import ClusterNNTry00_V22
...
if __name__ == '__main__':
    ...
    dp.target_min_cluster_count = 5
    dp.target_max_cluster_count = 5
    en = CnnEmbedding(
    ...
    c_nn = ClusterNNTry00_V22(dp, 20, en, lstm_layers=7, internal_embedding_size=96,
                              output_dense_layers=1, output_dense_units=256,

                              # There is only 1 possible cluster count: Minimize this part of the network (it is not used)
                              cluster_count_lstm_layers=1, cluster_count_lstm_units=1, cluster_count_dense_layers=1, cluster_count_dense_units=1
                              )
    ...
    autosave_dir = top_dir + 'test/autosave_ClusterNNTry00_V22'
