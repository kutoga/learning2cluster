...
from impl.nn.try00.cluster_nn_try00_v68 import ClusterNNTry00_V68
...
if __name__ == '__main__':
    ...
    c_nn = ClusterNNTry00_V68(dp, 40, en, lstm_layers=7, internal_embedding_size=96, cluster_count_dense_layers=1, cluster_count_dense_units=256,
    ...
    autosave_dir = top_dir + 'test/autosave_ClusterNNTry00_V68'
