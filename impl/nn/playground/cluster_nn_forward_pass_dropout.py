...
from core.nn.helper import slice_layer, ExtendedDropout
from impl.nn.base.simple_loss.simple_loss_cluster_nn_v02 import SimpleLossClusterNN_V02

class ClusterNNForwardPassDropout(SimpleLossClusterNN_V02):
    """
    This network contains the possibility to use a forward pass dropout. It is only used for
    the cluster count output.
    """
    ...
    def _build_network(self, network_input, network_output, additional_network_outputs):
        ...
        self._add_debug_output(cluster_count, '01_cluster_count_after_forward_pass_dropout')
