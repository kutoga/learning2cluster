...
from core.nn.helper import slice_layer, meier_cluster_cohesion, concat, regularizer_cluster_assignment
from impl.nn.base.simple_loss.simple_loss_cluster_nn_v02 import SimpleLossClusterNN_V02

# LSTM = CuDNNLSTM

class ClusterNNImplicationRule(SimpleLossClusterNN_V02):
