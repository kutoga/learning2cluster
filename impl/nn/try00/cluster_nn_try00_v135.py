...
from core.nn.helper import slice_layer, lukic_kl_divergence, reweight_values, concat, ExtendedDropout, regularizer_cluster_assignment
from impl.nn.base.simple_loss.simple_loss_cluster_nn_v02 import SimpleLossClusterNN_V02

# from keras.layers import LSTM
LSTM = CuDNNLSTM

class ClusterNNTry00_V135(SimpleLossClusterNN_V02):
