...
from core.nn.helper import slice_layer, lukic_kl_divergence, reweight_values, concat, ExtendedDropout, simple_recurrent_attention
from impl.nn.base.simple_loss.simple_loss_cluster_nn_v02 import SimpleLossClusterNN_V02

# from keras.layers import LSTM
LSTM = CuDNNLSTM

class ClusterNNTry00_V127(SimpleLossClusterNN_V02):
    def __init__(self, data_provider, input_count, embedding_nn=None, output_dense_units=512,
                 ...
                 simplified_center_loss_factor=1., attention_weight_layers=2):
        ...
        self.__attention_weight_layers = attention_weight_layers
    ...
    def _build_network(self, network_input, network_output, additional_network_outputs):
        ...
        for i in range(self.__lstm_layers):
            ...
            # Apply simple recurrent attention; first we have to define a weigh-function
