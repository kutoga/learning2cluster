...
class ClusterNNTry00_V66(SimpleLossClusterNN_V02):
    ...
    def _build_network(self, network_input, network_output, additional_network_outputs):
        ...
        # Implement the "hard"-hints: Do this after the center loss. This should make the center loss more usefull.
        embeddings_processed = reweight_values(embeddings_processed, self._get_clustering_hint())
