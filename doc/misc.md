...
# Commands
	...
	bash ./scripts/run.sh ./app2/test_cluster_nn_try00_v112.py ~/data/MT_gpulab/test_cluster_nn_try00_v112.py.log
	bash ./scripts/run.sh ./app2/test_cluster_nn_try00_v113.py ~/data/MT_gpulab/test_cluster_nn_try00_v113.py.log
	bash ./scripts/run.sh ./app2/test_cluster_nn_try00_v114.py ~/data/MT_gpulab/test_cluster_nn_try00_v114.py.log
	bash ./scripts/run.sh ./app2/test_cluster_nn_try00_v115.py ~/data/MT_gpulab/test_cluster_nn_try00_v115.py.log
	bash ./scripts/run.sh ./app2/test_cluster_nn_try00_v116.py ~/data/MT_gpulab/test_cluster_nn_try00_v116.py.log
	bash ./scripts/run.sh ./app2/test_cluster_nn_try00_v117.py ~/data/MT_gpulab/test_cluster_nn_try00_v117.py.log
	bash ./scripts/run.sh ./app2/test_cluster_nn_try00_v118.py ~/data/MT_gpulab/test_cluster_nn_try00_v118.py.log
	bash ./scripts/run.sh ./app2/test_cluster_nn_try00_v119.py ~/data/MT_gpulab/test_cluster_nn_try00_v119.py.log
	...
	N=125; srun --pty --ntasks=1 --cpus-per-task=1 --mem=32G --gres=gpu:1 shifter --image=meierbe8/meierbe8-keras6 bash \
	    ./scripts/run.sh ./app2/test_cluster_nn_try00_v$N.py ~/data/MT_gpulab/test_cluster_nn_try00_v$N.py.log
	N=125; srun --pty --ntasks=1 --cpus-per-task=1 --mem=32G --gres=gpu:1 shifter --image=meierbe8/meierbe8-keras6 bash \
	    ./scripts/run.sh ./app2/test_cluster_nn_try00_v$N.py ~/data/MT_gpulab/test_cluster_nn_try00_v$N_try02.py.log

	N=126; srun --pty --ntasks=1 --cpus-per-task=1 --mem=32G --gres=gpu:1 shifter --image=meierbe8/meierbe8-keras6 bash \
	    ./scripts/run.sh ./app2/test_cluster_nn_try00_v$N.py ~/data/MT_gpulab/test_cluster_nn_try00_v$N.py.log.2
	N=127; srun --pty --ntasks=1 --cpus-per-task=1 --mem=32G --gres=gpu:1 shifter --image=meierbe8/meierbe8-keras6 bash \
	    ./scripts/run.sh ./app2/test_cluster_nn_try00_v$N.py ~/data/MT_gpulab/test_cluster_nn_try00_v$N.py.log
	N=128; srun --pty --ntasks=1 --cpus-per-task=1 --mem=32G --gres=gpu:1 shifter --image=meierbe8/meierbe8-keras6 bash \
	    ./scripts/run.sh ./app2/test_cluster_nn_try00_v$N.py ~/data/MT_gpulab/test_cluster_nn_try00_v$N.py.log
	N=129; srun --pty --ntasks=1 --cpus-per-task=1 --mem=32G --gres=gpu:1 shifter --image=meierbe8/meierbe8-keras6 bash \
	    ./scripts/run.sh ./app2/test_cluster_nn_try00_v$N.py ~/data/MT_gpulab/test_cluster_nn_try00_v$N.py.log
	...
	N=133; srun --pty --ntasks=1 --cpus-per-task=1 --mem=32G --gres=gpu:1 shifter --image=meierbe8/meierbe8-keras6 bash \
	    ./scripts/run.sh ./app2/test_cluster_nn_try00_v$N.py ~/data/MT_gpulab/test_cluster_nn_try00_v$N.py.log
	N=134; srun --pty --ntasks=1 --cpus-per-task=1 --mem=32G --gres=gpu:1 shifter --image=meierbe8/meierbe8-keras6 bash \
	    ./scripts/run.sh ./app2/test_cluster_nn_try00_v$N.py ~/data/MT_gpulab/test_cluster_nn_try00_v$N.py.log
	N=135; srun --pty --ntasks=1 --cpus-per-task=1 --mem=32G --gres=gpu:1 shifter --image=meierbe8/meierbe8-keras6 bash \
	    ./scripts/run.sh ./app2/test_cluster_nn_try00_v$N.py ~/data/MT_gpulab/test_cluster_nn_try00_v$N.py.log
	N=136; srun --pty --ntasks=1 --cpus-per-task=1 --mem=32G --gres=gpu:1 shifter --image=meierbe8/meierbe8-keras6 bash \
	    ./scripts/run.sh ./app2/test_cluster_nn_try00_v$N.py ~/data/MT_gpulab/test_cluster_nn_try00_v$N.py.log
	N=137; srun --pty --ntasks=1 --cpus-per-task=1 --mem=32G --gres=gpu:1 shifter --image=meierbe8/meierbe8-keras6 bash \
	    ./scripts/run.sh ./app2/test_cluster_nn_try00_v$N.py ~/data/MT_gpulab/test_cluster_nn_try00_v$N.py.log
	N=138; srun --pty --ntasks=1 --cpus-per-task=1 --mem=32G --gres=gpu:1 shifter --image=meierbe8/meierbe8-keras6 bash \
	    ./scripts/run.sh ./app2/test_cluster_nn_try00_v$N.py ~/data/MT_gpulab/test_cluster_nn_try00_v$N.py.log
	N=139; srun --pty --ntasks=1 --cpus-per-task=1 --mem=32G --gres=gpu:1 shifter --image=meierbe8/meierbe8-keras6 bash \
	    ./scripts/run.sh ./app2/test_cluster_nn_try00_v$N.py ~/data/MT_gpulab/test_cluster_nn_try00_v$N.py.log
	N=140; srun --pty --ntasks=1 --cpus-per-task=1 --mem=32G --gres=gpu:1 shifter --image=meierbe8/meierbe8-keras6 bash \
	    ./scripts/run.sh ./app2/test_cluster_nn_try00_v$N.py ~/data/MT_gpulab/test_cluster_nn_try00_v$N.py.log
	N=141; srun --pty --ntasks=1 --cpus-per-task=1 --mem=32G --gres=gpu:1 shifter --image=meierbe8/meierbe8-keras6 bash \
	    ./scripts/run.sh ./app2/test_cluster_nn_try00_v$N.py ~/data/MT_gpulab/test_cluster_nn_try00_v$N.py.log
    ...
    # Neuer GPU cluster
    srun --pty --ntasks=1 --cpus-per-task=1 --mem=48G --gres=gpu:1 shifter --image=meierbe8/meierbe8-keras6 bash
