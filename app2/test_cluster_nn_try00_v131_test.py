...
if __name__ == '__main__':
    ...
    def get_cnn(dataprovider=None):
        ...
        en = CnnEmbedding(
            output_size=2, cnn_layers_per_block=1, block_feature_counts=[2],
        ...
        c_nn = ClusterNNTry00_V122(dataprovider, 9, en, lstm_layers=1, internal_embedding_size=2, cluster_count_dense_layers=1, cluster_count_dense_units=2,
                                  output_dense_layers=0, output_dense_units=2, cluster_count_lstm_layers=1, cluster_count_lstm_units=2,
                                  kl_embedding_size=2, kl_divergence_factor=0., simplified_center_loss_factor=0.)
        ...
        c_nn.validate_every_nth_epoch = 1 * validation_factor
        c_nn.validation_data_count = 10
    ...
    autosave_dir = top_dir + '/autosave_ClusterNNTry00_V131_test'
    ...
    for dataset in datasets:
        ...
        c_nn.test_network(count=10, output_directory=autosave_dir + '/examples_final_{}_metrics'.format(suffix), data_type='train', create_date_dir=False)
        break
