...
if __name__ == '__main__':
    ...
    speaker_list = TIMITDataProvider.load_speaker_list(ds_dir + 'datasets/TIMIT/traininglist_100/testlist_20.txt')[:5]
    ...
    autosave_dir = top_dir + '/autosave_ClusterNNTry00_V150'
