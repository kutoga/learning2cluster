...
if __name__ == '__main__':
    ...
    dp = DevangariCharactersDataProvider(
        ...
        data_csv_path=top_dir + 'devanagari-character-set.csv'
    ...
    def get_cnn(dataprovider=None):
        ...
        en = CnnEmbedding(
            output_size=2, cnn_layers_per_block=2, block_feature_counts=[2],
        ...
        c_nn = ClusterNNTry00_V122(dataprovider, 2, en, lstm_layers=2, internal_embedding_size=2, cluster_count_dense_layers=2, cluster_count_dense_units=2,
                                  output_dense_layers=0, output_dense_units=2, cluster_count_lstm_layers=2, cluster_count_lstm_units=2,
    ...
    autosave_dir = top_dir + '/autosave_ClusterNNTry00_V142'
