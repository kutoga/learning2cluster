...
if __name__ == '__main__':
    ...
    def get_cnn():
        c_nn = ClusterNNTry00_V135(dp, 72, en, lstm_layers=14, internal_embedding_size=96*3, cluster_count_dense_layers=1, cluster_count_dense_units=256,
                                  ...
                                  kl_embedding_size=128, kl_divergence_factor=0.1, simplified_center_loss_factor=0.5,
                                   cluster_assignment_regularization_factor=10.)
    ...
    autosave_dir = top_dir + '/autosave_ClusterNNTry00_V145'
    ...
    c_nn.test_network(count=60, output_directory=autosave_dir + '/examples_final', data_type='test', create_date_dir=False)
