...
if __name__ == '__main__':
    ...
    from impl.data.image.coil100_data_provider import Coil100DataProvider
    ...
    dp = Coil100DataProvider(
        top_dir + '../coil100_dataset/',
        min_cluster_count=1,
        max_cluster_count=5,
    ...
    def get_cnn(dataprovider=None):
        ...
        en = CnnEmbedding(
            ...
            dropout_init=0.5, dropout_after_fc=0.5
        )
    ...
    autosave_dir = top_dir + '/autosave_ClusterNNTry00_V138'
